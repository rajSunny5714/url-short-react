...
//         setLoader(true);
//         try {
//              const { data } = await api.get(`/api/urls/analytics/${selectedUrl}?startDate=2024-09-04T00:00:00&endDate=2026-10-30T23:59:59`, {
//                         headers: {
  ...
  const fetchMyShortUrl = async () => {
    ...
    try {
      const { data } = await api.get(
        `/api/urls/analytics/${selectedUrl}?startDate=2024-09-04T00:00:00&endDate=2026-10-30T23:59:59`,
        {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
      ...
      // Convert API data to array format compatible with Graph
